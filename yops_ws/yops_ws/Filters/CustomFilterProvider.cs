...
{
    /*
     * This class replaces IFilterProvider and will sort the custom filters based on their order.
     */
    public class CustomFilterProvider : IFilterProvider
    {
        public IEnumerable<FilterInfo> GetFilters(HttpConfiguration configuration, HttpActionDescriptor actionDescriptor)
        {
            ...
            {
                throw new ArgumentNullException("Action descriptor is null");
            }

            // convert all filters to CustomFilterInfo
            ...
            // return the sorted list of filters
